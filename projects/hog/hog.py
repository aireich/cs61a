...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            ...
            if abs(score0 - prev_score0) == 2 and feral_hogs:
                prev_score0 = score0
                score0 += 3
            who = other(who)
            announce()(score0, score1)
            
        else:
            score1 = take_turn(strategy1(score0, score1), score0, dice)
            if abs(score1 - prev_score1) == 2 and feral_hogs:
                prev_score1 = score1
                score1 += 3
            who = other(who)
            announce()(score0, score1)
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        ...
        if who == 0:
            if score0 - last > high:
                high = score0 - last
                print(score0 - last, " point(s)! That's the biggest gain yet for Player ", who)
            else:
                last = score0
        else:
            if score1 - last > high:
                high = score1 - last
                print(score1 - last, " point(s)! That's the biggest gain yet for Player ", who)
            else:
                last = score1
...
def make_averaged(original_function, trials_count=1000):
    ...
    # BEGIN PROBLEM 8
    def average(*args):
        all = [original_function(*args) for i in range(trials_count)]
        return sum(all) / trials_count
    return average
    # END PROBLEM 8
